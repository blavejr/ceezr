...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PokemonCeezr.CreatePokemonDto();
  });
  ...
  describe('CreatePokemonDto', function() {
    it('should create an instance of CreatePokemonDto', function() {
      // uncomment below and update the code to test CreatePokemonDto
      //var instance = new PokemonCeezr.CreatePokemonDto();
      //expect(instance).to.be.a(PokemonCeezr.CreatePokemonDto);
    });
